...
use wgpu_playground_core::dawn_wrapper::{
    DawnInstance, DawnPowerPreference, DawnDeviceDescriptor,
};
...
fn test_dawn_adapter_high_performance() {
    ...
    let adapter = pollster::block_on(
        instance.request_adapter(DawnPowerPreference::HighPerformance)
    );
...
fn test_dawn_adapter_low_power() {
    ...
    let adapter = pollster::block_on(
        instance.request_adapter(DawnPowerPreference::LowPower)
    );
...
fn test_dawn_device_creation() {
    ...
    // Request adapter
    let adapter = pollster::block_on(
        instance.request_adapter(DawnPowerPreference::Undefined)
    );
...
fn test_dawn_multiple_adapters() {
    ...
    let adapter1 = pollster::block_on(
        instance.request_adapter(DawnPowerPreference::Undefined)
    );
    
    let adapter2 = pollster::block_on(
        instance.request_adapter(DawnPowerPreference::HighPerformance)
    );
